...
type CommonContentQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type CommonContentQueryQuery = { readonly markdownRemark: { readonly html: string | null, readonly frontmatter: { readonly slug: string | null, readonly source: string | null, readonly author: string | null, readonly section: string | null, readonly title: string | null, readonly tags: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly parent: { readonly relativeDirectory: string } | {} | null } | null };

type FolderIndexQueryQueryVariables = Exact<{ [key: string]: never; }>;


type FolderIndexQueryQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly title: string | null, readonly slug: string | null, readonly section: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly parent: { readonly relativeDirectory: string } | {} | null }> } };
